...
* **비주얼 마크다운 편집** — 문서를 바로 편집하고,  `Visual`과 `Source` 모드 쉽게 전환
  ...
  * 접근성 좋은 Floating Control Bar

  * 코드 블록 내 Language 선택

* **Tech Stack Badge** — 기술 프리셋 검색 후 Shields.io 배지를 쉽게 삽입

* **파일 첨부** — 로컬 파일을 워크스페이스의 상대 경로로 복사하고 이미지 또는 링크로 삽입

* **표 편집** — 쉽게 표를 삽입하고 행과 열을 편집하며, 쉬운 정렬과 삭제

* **VSCode 동기화 -**  저장, 실행 취소·다시 실행, 외부 변경 동기화, 라이트·다크 테마와 한글 IME 입력을 지원

### Shortcuts

* macOS : `cmd` | Windows/Linux : `Ctrl`

* 서식 단축키 및 빠른 마크다운 입력은 `Visual` 모드에서 동작
